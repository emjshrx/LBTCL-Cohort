...
# Submission
 ...
 - This week's solution folder is here: [solution folder](/exercises/week%201/solutions/).
 ...
 - The exercise steps are mandatory to be reflected, but feel free to add your own scripting perks. We will showcase the best script of the week in the discord `shell-showcase` channel.
